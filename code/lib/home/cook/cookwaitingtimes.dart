...
class CookWaitingTimesPage extends StatefulWidget {
  const CookWaitingTimesPage({Key? key}) : super(key: key);

  @override
  _CookWaitingTimesPage createState() => _CookWaitingTimesPage();
}

class _CookWaitingTimesPage extends State<CookWaitingTimesPage> {
